...
Перем КаталогОтображений;

&Желудь("МенеджерОтображений")
&Верховный
...
Процедура УстановитьКаталогОтображений(Каталог) Экспорт
	КаталогОтображений = Каталог;
КонецПроцедуры
...
Функция ПолучитьОтображениеИзФайла(Знач ПутьДоФайла) Экспорт

	ПутьДоФайла = ОбъединитьПути(КаталогОтображений, ПутьДоФайла);
